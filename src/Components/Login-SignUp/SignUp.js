...
function SignUp(props) {
    ...
    return (
        ...
        {/* form container */}
            ...
            <label>
            <Field className='formik-fields' type='text' name='first_name' placeholder="First Name" />
            </label>
            {touched.first_name && errors.first_name && <p>{errors.first_name}</p>}
            <label>
            <Field className='formik-fields' type='text' name='last_name' placeholder="Last Name" />
            </label>
