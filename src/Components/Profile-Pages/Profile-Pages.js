        ...
        <>
            ...
            <Form>
                ...
                <Field name="role" component="select">
                    <option value="" disabled>Would you like to be a driver:</option>
                    <option value="true">Yes</option>
                    <option value="false">No</option>
                </Field>
                <Field name="Hobbies" component="select">
                    <option value="" disabled>Select your Hobby:</option>
                ...
                <Field name="audio_love" component="select">
                    <option value="" disabled>Audio I love:</option>
                    <option value="Pop">Pop</option>
                    <option value="Classical">Classical</option>
                </Field>
                <Field name="audio_hate" component="select">
                    <option value="" disabled>Audio I Hate:</option>
                    <option value="Pop">Pop</option>
                    <option value="Classical">Classical</option>
                </Field>
